...
| ----------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| `compute_correlation()`       | Calculates the Spearman correlation between RNA and protein expression for a user-defined list of genes **or** tissues and generates correlation plots. |
...
HPAanalyze(Tran et al., 2019) and gtexr(Warwick et al., 2025). These calls make the vignette building slow and network dependent. Hence I have used eval=false, and included static images for reference. Tests have been conducted for these functions and examples, and they do produce accurrate and expected results.
