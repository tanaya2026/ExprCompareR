    ...
    fluidRow(
      ...
      column(
        ...
        div(
          ...
          p("1. If you are interested in a gene list as input, from `Select Input Type` choose input type: Genes. Then, click on the 'Run Example (Genes)' button to view results."),
          p("2. If you are interested in a tissue list as input, from `Select Input Type` choose input type: Tissues. Then, click on the 'Run Example (Tissues)' button to view results."),
          br(),
