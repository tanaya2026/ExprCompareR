...
The package has prebuilt datasets like `normal_tissue` and `pathology`, to avoid dynamically downloading the protein expression datasets each time. Refer to `help` documentation `?normal_tissue` and `?pathology` for information on data.
